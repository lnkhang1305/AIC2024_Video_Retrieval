...
client.recreate_collection(
    collection_name='image_collection_b32',
    vectors_config=VectorParams(size=512, distance=Distance.COSINE)
)

clip_path = './clip-features-32'
clip_files = []
...
# docker run -p 6333:6333 -v C:\Users\Acer\Desktop\pipeline_test\qdrant_storage:/qdrant/storage qdrant/qdrant
